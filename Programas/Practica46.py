...
img = cv2.imread("Imagenes/fruitss.jpg")
img_grises = cv2.cvtColor(img,cv2.COLOR_BGR2GRAY)
ret,img_binarizada = cv2.threshold(img_grises,180,255,cv2.THRESH_BINARY)
...
img_ref = cv2.imread("Imagenes/ref3.jpg")
...
ret, img_ref_binarizada = cv2.threshold(img_ref_grises,180,255,cv2.THRESH_BINARY)
